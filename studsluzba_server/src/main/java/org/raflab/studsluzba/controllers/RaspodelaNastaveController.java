...
public class RaspodelaNastaveController {
	...
	@GetMapping(path = "/drzipredmet/all")
	public List<DrziPredmet> getDrziPredmetUSkolskojGodini(@RequestParam String idSkolskaGodina) {
		return drziPredmetRepo.getDrziPredmetForSkolskaGodina(Long.valueOf(idSkolskaGodina));			
	}
	
	
	@GetMapping(path = "/drzipredmet/aktivna/all")
	public List<DrziPredmet> getDrziPredmetUAktivnojSkolskojGodini() {
		return drziPredmetRepo.getDrziPredmetAktivnaSkolskaGodina();			
	}
