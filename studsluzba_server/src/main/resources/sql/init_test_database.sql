...
INSERT INTO `predmet` (`espb`, `fond_predavanja`, `fond_vezbe`, `godina_studija`, `naziv`, `semestar`, `sifra`, `stud_program_id`) VALUES ('8', '2', '4', '1', 'Uvod u programiranje', '1', '1002a', 1);

INSERT INTO `predmet` (`espb`, `fond_predavanja`, `fond_vezbe`, `godina_studija`, `naziv`, `semestar`, `sifra`, `stud_program_id`) VALUES ('8', '2', '2', '1', 'Diskretne strukture', '1', '1003a', 1);
